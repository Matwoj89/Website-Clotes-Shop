...
namespace Strona
{
    public partial class Koszyk : System.Web.UI.Page
    {
        ...
        protected void BindData()
        {
            ...
            gvShoppingCart.DataSource = KoszykC.Instance.Items;
        ...
        protected void gvShoppingCart_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                e.Row.Cells[3].Text = "Całkowita kwota: " + KoszykC.Instance.GetSubTotal().ToString("C");
            }
        }
        ...
        protected void gvShoppingCart_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Remove")
            {
                ...
                KoszykC.Instance.RemoveItem(productId);
            }
            ...
            foreach (GridViewRow row in gvShoppingCart.Rows)
            {
                if (row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    try
                    {
                        ...
                        KoszykC.Instance.SetItemQuantity(productId, quantity);
                    }
